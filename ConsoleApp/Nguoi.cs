...
namespace DoAnCuoiKiOOP_v2
{
    public class Nguoi
    {
        ...
        public Nguoi(string hoVaTen, string cccd, string sdt, bool gioiTinh, DateTime ngaySinh, string ngheNghiep, string diaChi, string tenDangNhap, string matKhau)
        {
            ...
            this.tuoi = DateTime.Now.Year - ngaySinh.Year;
            this.diaChi = diaChi;
        ...
        public static object DangKy(int mode)
        {
            ...
            int tempGioiTinh = Inputter.GetInteger("Giới tính ('1' - Nam|'0' - Nữ): ", "Không hợp lệ!", 0, 1);
            bool gioiTinh = tempGioiTinh == 1;
            DateTime ngaySinh;
        NHAP_LAI_NGAY_SINH:
            try
            {
            ...
            switch (mode)
            {
                case 0:
                    {
                        return new NguoiChoThue(hoVaTen, cccd, sdt, gioiTinh, ngaySinh, ngheNghiep, diaChi, tenDangNhap, matKhau);
                        //break;
                    }
                case 1:
                    {
                        return new NguoiThue(hoVaTen, cccd, sdt, gioiTinh, ngaySinh, ngheNghiep, diaChi, tenDangNhap, matKhau);
                        //break;
                    }
                default:
                    {
                        return new Nguoi(hoVaTen, cccd, sdt, gioiTinh, ngaySinh, ngheNghiep, diaChi, tenDangNhap, matKhau);
                        //break;
                    }
            }
